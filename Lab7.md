...
ex <- read_sav("/Users/nehirarpat/Documents/GitHub/Lab7/ex.sav")

lab7<-read.csv("/Users/nehirarpat/Documents/GitHub/Lab7/lab7.csv")
```
...
![](Lab7_files/figure-gfm/unnamed-chunk-4-2.png)<!-- --> Extraversion,
agreeableness, conscientiousness, and emotional stability are the
personality traits that are correlated with satisfaction with life
...
13.8% of the variance in satisfaction with life is explained by the Big
5. Extraversion, emotional stability, and openness can explain unique
variance. To improve SWL, one could try becoming more extraverted and
emotionaly stable while less open.
